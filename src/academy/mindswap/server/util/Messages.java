...
public class Messages {
    ...
    public static final String GOODBYE_MESSAGE = "HAHAHA I knew from the start that you were a quitter...BUUUUHHHH";

    public static final String GOODBYE_IN_LOVE = "Ohhh now that I was seeing that you were smart enough to be with me...";
    ...
    public static final String WELCOME_SERVER = "" +
            "   ______ \n" +
            "  /     /| \n" +
            " /     /#|-----------(Hello" + PLAYER_NAME + "! Welcome to the funnest day of your life!\"\n" +
